...
export const { useRegisterMutation, useLoginMutation, useSendOTPMutation, useVerifyOTPMutation, useGetProfileQuery, useUpdateProfileMutation, useLogoutMutation } =
  authApi;
